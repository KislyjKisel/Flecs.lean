...
#define LEAN_FLECS_AppDesc_LAYOUT 0, 2, 0, 2, 0, 1, 2
#define LEAN_FLECS_AppDesc_targetFps F64, 0, LEAN_FLECS_AppDesc_LAYOUT
#define LEAN_FLECS_AppDesc_deltaTime F64, 1, LEAN_FLECS_AppDesc_LAYOUT
...
#define LEAN_FLECS_AppDescX_LAYOUT 0, 5, 0, 2, 0, 1, 2
#define LEAN_FLECS_AppDescX_targetFps F64, 0, LEAN_FLECS_AppDescX_LAYOUT
#define LEAN_FLECS_AppDescX_deltaTime F64, 1, LEAN_FLECS_AppDescX_LAYOUT
